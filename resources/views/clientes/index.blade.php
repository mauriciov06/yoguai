...
@section('content')
	<div class="sub-nav-item">
		<i class="fa fa-users fa-2x" aria-hidden="true"></i>  <h4>Listado de Clientes</h4>
	</div>
	...
	<div class="users">
		<table class="table table-sty">
			...
			<tbody>
				...
				<td>
					{!!link_to_route('clientes.edit', $title = 'Editar', $parameters = $user->id, $attributes = ['class'=>'btn btn-primary'])!!}
